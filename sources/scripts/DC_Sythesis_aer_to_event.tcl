...
set output_file_db "${sources_synth_outputs_dir}aer_to_event_synthesized_design.db"
set output_file_glnet "${sources_synth_outputs_dir}aer_to_event_glnet.v"
set output_file_sdf "${sources_synth_outputs_dir}aer_to_event.sdf"
set output_file_sdc "${sources_synth_outputs_dir}aer_to_event.sdc"
