...
set output_file_db "${sources_synth_outputs_dir}dvs_ravens_synthesized_design.db"
set output_file_glnet "${sources_synth_outputs_dir}dvs_ravens_glnet.v"
set output_file_sdf "${sources_synth_outputs_dir}dvs_ravens.sdf"
set output_file_sdc "${sources_synth_outputs_dir}dvs_ravens.sdc"
