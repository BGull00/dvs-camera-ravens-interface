...
set output_file_sdf "${sources_synth_outputs_dir}fifo_event_queue.sdf"
set output_file_sdc "${sources_synth_outputs_dir}fifo_event_queue.sdc"
...
# Define file paths
set design_files [list "dvs_fifo_event_queue.sv" "sram_compiled_array_empty.sv"] 
...
current_design dvs_fifo_event_queue
...
elaborate dvs_fifo_event_queue
